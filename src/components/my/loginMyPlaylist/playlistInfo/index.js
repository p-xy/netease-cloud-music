        ...
        return (
            <div style={{ marginBottom:"50px" }}>
                <div style={{ width:"208px",height:"208px",border:"1px solid #ccc",display:"inline-block" }}>
                    <img src={this.props.coverImgUrl} style={{   width:"208px",height:"208px" }} alt=''/>
                </div>
                <div style={{ display:"inline-block",verticalAlign:"top",marginLeft:"20px" }}>
                    ...
                    <div style={{ marginTop:"15px" }}>
                        <img style={{ width:"35px",height:"35px",cursor:"pointer" }} alt='' onClick={ ()=>this.dumpUser() } src={this.props.creatorImg} />
